...
*/
  ...
  (function () {
    var addDocumentNodes,
      addDocumentNodesScheduled,
      addMap,
      addNodes,
      applyChanges,
      changedTargets,
      documentObserver,
      documentObservers,
      handleAsyncChangeEvents,
      handleChangeEvent,
      handleDocumentMutations,
      initMap,
      initializerMap,
      innerHTMLReplacementIsBuggy,
      removeNodes,
      revalidateDescendantObservers,
      revalidateObservers,
  ...
  (function () {
    $(document).on("ready pjax:success", function () {
      ...
      clipper.on("success", function (event) {
        var notice;
        notice =
          '<div class="flash notice"><div class="flash-inner">API token copied to clipboard.</div></div>';
        if ($(".flash").length > 0) {
  ...
  (function () {
    $(document).ready(function () {
      ...
      $(".js-admin-package-search-results").on(
        "click",
        ".js-add-to-list",
        function (e) {
          var li, newLi;
          ...
          newLi
            .find(".js-add-to-list")
            .removeClass("add-button js-add-to-list")
            .addClass("delete-button js-remove-from-list")
            .find(".octicon")
            .removeClass("octicon-move-down")
            .addClass("octicon-trashcan");
          $(".js-package-sort").prepend(newLi);
          li.find(".js-add-to-list").replaceWith(
      ...
      $(".js-admin-package-search-results").on(
        "click",
        ".js-admin-search-pagination a",
        function (e) {
          e.stopPropagation();
          e.preventDefault();
          return $(".js-admin-package-search-results").load(
      ...
      $(".js-user-search-result .js-eligible-for-reward").on(
        "change",
        function (e) {
      ...
      return $(".js-user-delete-confirm-form").on("submit", function (e) {
        ...
        if (
          !(
            entered === $("input[name=user-delete-confirm-username]").val() &&
            entered !== ""
          )
        ) {
          return false;
  ...
  (function () {
    ...
    $(document).ready(function () {
      ...
      $(document).pjax(
        ".documents a:not([data-remote]):not([data-behavior]):not([data-skip-pjax])",
        "#js-pjax-container",
      );
  ...
  (function () {
    ...
    activate = function (container) {
      ...
      $(container).fire("menu:activate", function () {
        ...
        $(container).performTransition(function () {
          ...
          return $(container)
            .find(".js-menu-content[aria-hidden]")
    ...
    onKeyDown = function (event) {
      ...
      if (event.hotkey === "esc") {
        if (
          indexOf.call($(document.activeElement).parents(), activeContainer) >=
          0
        ) {
          document.activeElement.blur();
        }
  ...
  (function () {
    $(document).on(
      "ajaxSuccess",
      ".js-select-menu:not([data-multiple])",
      function () {
  ...
  (function () {
    $(document).on(
      "selectmenu:selected",
      ".js-select-menu .js-navigation-item",
      function () {
        ...
        if (text[0]) {
          return container
            .find(".js-select-button-gravatar")
            .html(gravatar.html());
        }
      },
    );
  ...
  (function () {
    $(document).on(
      "selectmenu:change",
      ".js-select-menu .select-menu-list",
      function (event) {
        var empty, items;
  ...
  (function () {
    $(document).on(
      "menu:activated selectmenu:load",
      ".js-select-menu",
      function () {
    ...
    $(document).on("menu:deactivate", ".js-select-menu", function () {
      return $(this)
        .find(".js-filterable-field")
        .val("")
        .trigger("filterable:change");
    });
  }).call(this);
  (function () {
    $(document).on(
      "navigation:open",
      ".js-select-menu:not([data-multiple]) .js-navigation-item",
      function () {
        var $container, $el;
        $el = $(this);
    ...
    $(document).on(
      "navigation:open",
      ".js-select-menu[data-multiple] .js-navigation-item",
      function () {
        var $el, selected;
        $el = $(this);
  ...
  (function () {
    ...
    $.fn.scrollTo = function () {
      ...
      if (options.top == null && options.left == null) {
        if (options.target) {
          (ref = $(options.target).positionedOffset(container)),
            (top = ref.top),
            (left = ref.left);
          options.top = top;
          options.left = left;
        } else {
          (ref1 = $(container).positionedOffset()),
            (top = ref1.top),
            (left = ref1.left);
          options.top = top;
          options.left = left;
  ...
  (function () {
    var activate,
      ...
      scrollItemTo,
      scrollPageTo,
      unbindNavigationMouseListeners;
    ...
    $(document).on("keydown", function (event) {
      ...
      target =
        $(container).find(".js-navigation-item.navigation-focus")[0] ||
        container;
    ...
    $(document).on(
      ...
      function (event) {
        ...
        if (
          (a =
            $(this).filter(".js-navigation-open")[0] ||
            $(this).find(".js-navigation-open")[0])
        ) {
    ...
    clear = function (container) {
      $(container)
        .find(".navigation-focus.js-navigation-item")
    ...
    pageUp = function (item, container) {
      ...
      while (
        ...
        $(previous).overflowOffset(container).top >= 0
      ) {
        index--;
      }
      if (previous) {
    ...
    pageDown = function (item, container) {
      ...
      while (
        (next = items[index + 1]) &&
        $(next).overflowOffset(container).bottom >= 0
      ) {
        index++;
      }
      if (next) {
    ...
    getScrollStyle = function (container) {
      var ref;
      return (ref = $(container).attr("data-navigation-scroll")) != null
        ? ref
        : "item";
    };
  ...
  (function () {
    ...
    $(document).on(
      "filterable:change selectmenu:tabchange",
      ".js-select-menu .select-menu-list",
      function () {
  ...
  (function () {
    ...
    $(document).on(
      "click",
      ".js-select-menu .js-select-menu-tab",
      function (event) {
        var $menu;
    ...
    toggleTabBucket = function (tab, state) {
      ...
      $buckets = $(tab)
        .closest(".js-select-menu")
        .find(".js-select-menu-tab-bucket");
  ...
  (function ($) {
    ...
    $.fn.addressfield = function (options) {
      ...
      if (typeof configs.json === "string") {
        $.ajax({
          ...
          async: configs.async,
          success: function (data) {
            $.fn.addressfield.binder.call(
              $container,
              configs.fields,
              $.fn.addressfield.transform(data),
            );
      ...
      // In this case, a direct configuration has been provided inline.
        ...
        $.fn.addressfield.binder.call(
          $container,
          configs.fields,
          $.fn.addressfield.transform(configs.json),
        );
        $(configs.fields.country).change();
        return $container;
      }
      ...
      // @deprecated Remove this functionality in the next major version (2.0.x).
        ...
        return $.fn.addressfield.apply.call(
          $container,
          configs.defs,
          configs.fields,
        );
    ...
    $.fn.addressfield.apply = function (config, fieldMap) {
      ...
      for (fieldPos in config.fields) {
        ...
        selector = fieldMap.hasOwnProperty(field)
          ? fieldMap[field]
          : "." + field;
        ...
        if (config.fields[fieldPos][field] instanceof Array) {
          return $.fn.addressfield.apply.call(
            $element,
            { fields: config.fields[fieldPos][field] },
            fieldMap,
          );
        }
        // Otherwise perform the usual actions.
          ...
          if ($element.length && fieldMap.hasOwnProperty(field)) {
            ...
            if (typeof config.fields[fieldPos][field].options !== "undefined") {
              ...
              $.fn.addressfield.updateOptions.call(
                $element,
                config.fields[fieldPos][field].options,
              );
            } else {
              ...
              placeholder = config.fields[fieldPos][field].hasOwnProperty("eg")
                ? config.fields[fieldPos][field].eg
                : "";
              $.fn.addressfield.updateEg.call($element, placeholder);
            }

            // Update the label.
            $.fn.addressfield.updateLabel.call(
              $element,
              config.fields[fieldPos][field].label,
            );
          }

          // When adding fields that didn't previously exist.
          if (
            !$.fn.addressfield.isVisible.call($element) &&
          ...
          $.fn.addressfield.validate.call(
            $element,
            field,
            config.fields[fieldPos][field],
          );
        }
      }
      ...
      $.each(fieldMap, function (field_name, field_selector) {
        ...
        if (
          $element.length &&
          !$.fn.addressfield.hasField(config, field_name)
        ) {
    ...
    $.fn.addressfield.binder = function (fieldMap, countryConfigMap) {
      ...
      $(fieldMap.country).bind("change", function () {
        ...
        $.fn.addressfield.apply.call(
          $container,
          countryConfigMap[this.value],
          fieldMap,
        );
      });
    ...
    $.fn.addressfield.hasField = function (config, expectedField) {
      ...
      for (pos in config.fields) {
        ...
        if (config.fields[pos][field] instanceof Array) {
          return $.fn.addressfield.hasField(
    ...
    $.fn.addressfield.validate = function (field, config) {
      ...
      if (typeof $.validator !== "undefined") {
        ...
        message = $.validator.messages.hasOwnProperty(methodName)
          ? $.validator.messages[methodName]
          : message;
    ...
    $.fn.addressfield.container = function () {
      ...
      if (typeof $.fn.has === "function") {
        ...
        return $this
          .parents()
          .find(":has(label):has(#" + elementName + "):last");
      }
    };
      ...
      this.each(function (i, cont) {
        ...
        var newList = {
          ...
          init: function () {
            ...
            opts.tagName =
              $(this.container).children().size() == 0
                ? "li"
          ...
          uninit: function () {
            ...
            $(list.container)
              .unbind("mousedown", list.grabItem)
  ...
  (function ($) {
    ...
    updatePerformanceBar = function (results) {
      ...
      for (key in results.data) {
        for (label in results.data[key]) {
          $("[data-defer-to=" + key + "-" + label + "]").text(
            results.data[key][label],
          );
        }
      }
    ...
    initializeTipsy = function () {
      return $("#peek .peek-tooltip, #peek .tooltip").each(function () {
        ...
        el = $(this);
        gravity =
          el.hasClass("rightwards") || el.hasClass("leftwards")
            ? $.fn.tipsy.autoWE
            : $.fn.tipsy.autoNS;
        return el.tipsy({
          gravity: gravity,
  ...
  (function () {
    ...
    PerformanceBar = (function () {
      ...
      PerformanceBar.prototype.addBar = function (
        name,
        color,
        start,
        end,
    ...
    $(document).on(
      "pjax:start page:fetch turbolinks:request-start",
      function (event) {
...
/*
     FILE ARCHIVED ON 00:48:16 Dec 07, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:07:12 Jun 04, 2023.
...
/*
playback timings (ms):
  captures_list: 83.868
  exclusion.robots: 0.063
  exclusion.robots.policy: 0.055
  cdx.remote: 0.051
  esindex: 0.008
  LoadShardBlock: 55.285 (3)
  PetaboxLoader3.datanode: 96.255 (5)
  load_resource: 220.312 (2)
  PetaboxLoader3.resolve: 97.606 (2)
*/
