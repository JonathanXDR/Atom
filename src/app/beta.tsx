    ...
    <>
      <head>
        ...
        <link
          ...
          href="https://web.archive.org/web/20221207004901/https://atom.io/packages.atom"
        />
      </head>
            ...
            <div className="wrapper no-pad">
              <ul className="navigation">
                <li>
                  <h1>
                    <a
                      href="https://web.archive.org/web/20221207004901/https://atom.io/"
                ...
                <li>
                  <a
                    className=""
                    href="https://web.archive.org/web/20221207004901/https://atom.io/packages"
                  >
                    Packages
                  </a>
                </li>
                <li>
                  <a
                    className=""
                    href="https://web.archive.org/web/20221207004901/https://atom.io/themes"
                  >
                    Themes
                  </a>
                </li>
                <li>
                  <a
                    className=""
                    href="https://web.archive.org/web/20221207004901/https://atom.io/docs"
                  >
                    Documentation
                  </a>
                </li>
                ...
                <div className="wrapper">
                  <header className="hero-header">
                    ...
                    <ul className="hero-header-item hero-download">
                      ...
                      <li>
                        <a
                          href="https://web.archive.org/web/20221207004901/https://atom.io/download/windows_x64?channel=beta"
