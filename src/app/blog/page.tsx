  ...
  return (
    <>
      <head>
        ...
        <meta
          property="og:url"
          content="https://web.archive.org/web/20221207004825/https://blog.atom.io/"
        />
        <meta property="og:site_name" content="Atom Blog" />
        <meta property="og:type" content="website" />
        <link
          rel="next"
          href="https://web.archive.org/web/20221207004825/https://blog.atom.io/page2"
        />
        <meta name="twitter:card" content="summary" />
        <meta property="twitter:title" content="Atom Blog" />
              ...
              <ul className="posts">
                <li className="post">
                  ...
                  <div className="post markdown">
                    <p>
                      Atom 1.39 speeds up find-and-replace operations by an
                      order of magnitude, improves loading performance for
                      large, single-line files, and upgrades Atom to Electron
                      3.1. Atom 1.40 beta brings richer integration with GitHub
                      pull requests, improved reliability for many common
                      operations, and continued enhancements to support for
                ...
                <li className="post">
                  ...
                  <div className="post markdown">
                    <p>
                      ...
                      pull request and an experimental faster mode in fuzzy
                      finder that dramatically improves its performance.
                    </p>
                ...
                <li className="post">
                  ...
                  <div className="post markdown">
                    <p>
                      Atom 1.36 has shipped! Upgrade today to open single files
                      in large directories much faster, see pull request review
                      comments from GitHub, specify multiple wrap guides at
                      once, and more.
                    </p>
                ...
                <li className="post">
                  ...
                  <div className="post markdown">
                    <p>
                      ...
                      requests directly within Atom, and a variety of
                ...
                <li className="post">
                  ...
                  <p className="who-when">
                    <span className="octicon octicon-calendar"></span> January
                    8, 2019
                    <a
                      href="https://web.archive.org/web/20221207004825/https://github.com/jasonrudolph"
                      className="author-link"
                ...
                <li className="post">
                  ...
                  <div className="post markdown">
                    <p>
                      ...
                      functionality, and faster performance for bracket
                      matching.
                    </p>
                ...
                <li className="post">
                  ...
                  <div className="post markdown">
                    <p>
                      ...
                      direct feedback from humans about how they work and how
                      what we build affects that workflow.
                    </p>
