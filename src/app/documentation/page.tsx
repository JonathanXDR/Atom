  ...
  return (
    <>
      <head>
        ...
        <meta
          name="csrf-token"
          content="Sn3m6phjs1wxS446RZXLDxj9PV70Pg1WGgS3Sxf9Nud++QIg7aylGK/dZoodD7rhUQWNCgxFCpWKxNHvxDIppQ=="
        />
        <meta
          property="og:url"
          content="https://web.archive.org/web/20221207004847/https://atom.io/"
        />
        ...
        <link
          rel="shortcut icon"
          href="https://web.archive.org/web/20221207004847im_/https://atom.io/favicon.ico"
        />
        <link
          rel="alternate"
          type="application/atom+xml"
          title="Atom Packages and Themes"
          href="https://web.archive.org/web/20221207004847/https://atom.io/packages.atom"
        />
      </head>
      <body>
                        ...
                        <div className="doc-section">
                          ...
                          <p>
                            ...
                            <a href="https://web.archive.org/web/20221207004847/https://flight-manual.atom.io/">
                              Go here to read the one and only book on
                              everything Atom.
                            </a>
                          </p>
                          <p>
                      ...
                      <td valign="top" width="33%">
                        <div className="doc-section">
                          ...
                          <p>
                            ...
                            is automatically generated from the Atom source
                            code. Go here to see what tools you can use to build
                            your own plugins.
                          </p>
                          <a href="https://web.archive.org/web/20221207004847/https://flight-manual.atom.io/api">
                            View all API docs
                      ...
                      <td valign="top" width="33%">
                        <div className="doc-section">
                          ...
                          <p>
                            ...
                            problems or are looking for help, this is your
                            place.
                          </p>
                        </div>
                      </td>
