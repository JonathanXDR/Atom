        ...
        <nav className="top-bar" aria-label="Primary">
          <div className="wrapper no-pad">
            ...
            <div className="top-bar-right">
              <Link href="https://atom.io/login?last_url=%2Freleases">
                ...
                <ul>
                  ...
                  <li>
                    <Link href="https://github.com/atom/atom/pull/23647">
                      atom/atom#23647 - deps: &quot;downgrade&quot; node-fetch
                      to ^v2.6.7 in script/ (fix &quot;Bump dependencies&quot;
                      job in Nightly CI)
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="https://github.com/atom/atom/pull/25459">
                      atom/atom#25459 - New &quot;Open Package Manager&quot;
                      menu item
                    </Link>
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    <Link href="https://github.com/atom/language-css/pull/183">
                      atom/language-css#183 - Revert &quot;adjust tag-names
                      match to fix downstream issue in language-less&quot;
                    </Link>
                  </li>
                </ul>
              </div>
                ...
                <ul>
                  <li>
                    <Link href="https://github.com/atom/atom/pull/21753">
                      atom/atom#21753 - Fix handling of &quot;empty&quot;
                      language injections with Tree-sitter
                    </Link>
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    <Link href="https://github.com/atom/github/pull/2631">
                      atom/github#2631 - Fix github failing tests for
                      Atom&apos;s electron 9.4.1 upgrade
                    </Link>
                  </li>
                </ul>
                <h3>
                ...
                <ul>
                  ...
                  <li>
                    <Link href="https://github.com/atom/atom/pull/20879">
                      ...
                      &quot;ELECTRON_CUSTOM_VERSION&quot; env var in build
                      scripts
                    </Link>
                  </li>
                  <li>
