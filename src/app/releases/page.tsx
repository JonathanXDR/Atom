        ...
        <Box className="markdown-body">
          ...
          <Box className="release">
            ...
            <Text as="p">
              ...
              all repositories under the Atom organization on December 15, 2022.
            </Text>
            <Text as="p">
          ...
          <Box className="release">
            ...
            <Box as="ul">
              <Box as="li">
                <Link href="https://github.com/atom/github/pull/2676">
                  atom/github#2676 - Hotfix in restore discard history of files
                  with same name
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/language-ruby/pull/240">
                  atom/language-ruby#240 - Add ERB highlighting inside of script
                  tags
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/language-ruby/pull/224">
                  ...
                  <code>self</code>, differentiate <code>-&gt;</code>
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/13821">
                  ...
                  />
                  Clarify that stack only has an effect if detail is present as
                  well
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/23001">
                  atom/atom#23001 - bootstrap: Update Node requirement to 10.12+
                  in system requirement checker
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/19251">
                  atom/atom#19251 - Only allow drag-and-drop to succeed on panes
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/language-css/pull/182">
                  atom/language-css#182 - Add in @-ms-viewport and @-o-viewport
                  to CSS grammar
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/22652">
                  atom/atom#22652 - Bump <code>async</code> dependency to 3.2.0
                  in /script
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/22741">
                  atom/atom#22741 - For glibc compatibility use Ubuntu 18.04 as
                  environment
                </Link>
              </Box>
              <Box as="li">
          ...
          <Box className="release">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                ...
                - Add ability to collapse archived directories (zip, tar, e.t.c)
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/22372">
                  atom/atom#22372 - Bump hosted-git-info from 2.7.1 to 2.8.9 in
                  /packages/about
                </Link>
              </Box>
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/22371">
                  atom/atom#22371 - Bump hosted-git-info from 2.7.1 to 2.8.9 in
                  /script/vsts
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/22446">
                  atom/atom#22446 - Update README.md to match the move to Github
                  Discussion
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/22421">
                  atom/atom#22421 - Replaced the old Atom document icon with the
                  Big Sur icon
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/bracket-matcher/pull/405">
                  atom/bracket-matcher#405 - Handle multicursor selection inside
                  brackets
                </Link>
              </Box>
            </Box>
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/find-and-replace/pull/932">
                  atom/find-and-replace#932 - Added &quot;Open in New Tab&quot;
                  and &quot;Open in New Window&quot; right-click context menu
                  options
                </Link>
              </Box>
              <Box as="li">
            ...
            <Heading as="h3">
              ...
              <Link href="https://github.com/atom/whitespace">whitespace</Link>
            </Heading>
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/whitespace/pull/182">
                  atom/whitespace#182 - 🤖 Configure probot/no-response to allow
                  28 days when requesting more info on an issue
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/language-php/pull/397">
                  atom/language-php#397 - Support UTF-8 characters in namespaces
                  and className names
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/language-python/pull/315">
                  atom/language-python#315 - Add a lookahead for DELETE to avoid
                  mistaking HTTP strings for SQL
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/21927">
                  atom/atom#21927 - fix: require .node files directly to detect
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/22080">
                  atom/atom#22080 - Fix tree-sitter-language-mode null highlight
                  iterators
                </Link>
              </Box>
            </Box>
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/github/pull/2621">
                  atom/github#2621 - package.json: pin @babel/core to less than
                  7.12.10
                </Link>
              </Box>
              <Box as="li">
                <Link href="https://github.com/atom/github/pull/2625">
                  atom/github#2625 - Update shell.openExternal to promise due to
                  electron update on atom
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/github/pull/2572">
                  atom/github#2572 - Increase priority of login prompt on GitHub
                  tab
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/github/pull/2617">
                  atom/github#2617 - test: Disable failing file-patch tests for
                  Atom CI
                </Link>
              </Box>
            </Box>
          ...
          <Box className="release">
            ...
            <Box as="ul">
              <Box as="li">
                ...
                Fixes syntax highlighting bug across languages(Javascript, Ruby,
          ...
          <Box className="release">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/21446">
                  atom/atom#21446 - Clarify the context under which log-file is
                  used
                </Link>
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/tree-view/pull/1358">
                  atom/tree-view#1358 - Fix Uncaught Error: ENOENT: no such file
                  or directory
                </Link>
              </Box>
            </Box>
          ...
          <Box className="release">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                ...
                - The alt text on your avatar in the Git tab no longer overflows
                when you&apos;re offline.
              </Box>
              <Box as="li">
                <Link href="https://github.com/atom/tree-view/pull/1358">
          ...
          <Box className="release">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                ...
                - Add missing operators: spread, exponentiation, null coalescing
              </Box>
              <Box as="li">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/20879">
                  atom/atom#20879 - Use the &quot;ELECTRON_CUSTOM_VERSION&quot;
                  env var in build scripts
                </Link>
              </Box>
              <Box as="li">
          ...
          <Box className="release">
            ...
            <Box as="ul">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/20444">
                  atom/atom#20444 - feat: add setting to disable multi cursor on
                  click
                </Link>
              </Box>
              <Box as="li">
          ...
          <Box className="release">
            ...
            <Box as="ul">
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/20494">
                  atom/atom#20494 - Bump Azure Devops Windows images to version
                  vs2017-win2016
                </Link>
              </Box>
              <Box as="li">
              ...
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/19862">
                  atom/atom#19862 - Add overlay when resizing panels to prevent
                  panes stealing focus
                </Link>
              </Box>
              <Box as="li">
                <Link href="https://github.com/atom/atom/pull/20406">
            ...
            <Heading as="h3">
              ...
              <Link href="https://github.com/atom/language-c">language-c</Link>
            </Heading>
            ...
            <Box as="ul">
              <Box as="li">
                <Link href="https://github.com/atom/language-ruby/pull/276">
                  atom/language-ruby#276 - [tree-sitter] add variable identifier
                  support in assignments expressions
                </Link>
              </Box>
            </Box>
          </Box>
